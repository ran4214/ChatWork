...
public class ChatController {
	...
	public void sendChatPOST(String fromID, String toID, String chatContent, HttpServletResponse response)
			throws Exception {
		response.setContentType("text/html;charset=UTF-8");
	...
	public void getUnreadChatCountPOST(String myUserID, @RequestParam(value = "friends[]") Integer[] friends,
